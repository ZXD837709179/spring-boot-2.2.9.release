...
@AutoConfigurationPackage //自动配置包 作用是定义springboot的扫描的方向 com.ke
@Import(AutoConfigurationImportSelector.class) //导入AutoConfigurationImportSelector组件，加载各个组件位于meta-info目录下的各个配置文件
